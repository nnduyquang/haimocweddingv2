    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="form-inline">
                    {!! Form::text('image-mobile', url('/').'/'.$location->image_mobile, array('placeholder' => '','class' => 'form-control','id'=>'pathImageMobile')) !!}
                    {!! Form::button('Browses', array('id' => 'btnBrowseMini','class'=>'btn btn-primary')) !!}
                </div>
                <div class="form-group">
                    {{ Html::image($location->image_mobile,'',array('id'=>'showDDMini','class'=>'showDDMini'))}}
                </div>
            </div>
        </div>
        <div class="col-md-3">
