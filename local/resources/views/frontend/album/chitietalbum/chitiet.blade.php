<div id="chitiet-album" class="col-md-12">
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                {{ Html::image('images/temps/NAMZ1888_1495329608601.jpg','',array('class'=>'img-top')) }}
            </div>
        </div>
        <h3 class="title">Tên Album</h3>
        <div class="col-md-12">
            <div class="row">
                        ...
                        <div class="grid-haha">
                            ...
                            <div class="grid-item">
                                <a class="fancybox" data-fancybox="gallery"
                                   href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/82/orange-tree.jpg">
